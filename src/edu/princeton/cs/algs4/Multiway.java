...
public class Multiway { 
    ...
    /**
     *  Reads N sorted text files specified as command-line arguments;
     *  merges them together into a sorted output stream; and writes
     *  the results to standard output.
     *  Note: this client does not check that the input streams are sorted.
     */
